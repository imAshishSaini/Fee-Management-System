          ...
          <table id="t01">
            ...
            while($data = mysqli_fetch_array($query)){
              ...
              <tr>
                ...
                <td><a href="deleteStudent3.php?id=<?php echo $data['id']?>" data-toggle="tooltip" data-placement="bottom" title="Delete"> <i class="fa fa-trash" style="font-size: 20px; color: red; align-items: center;" ></i></a></td>
              </tr>
              <?php
            }
            ?>
