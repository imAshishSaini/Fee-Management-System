  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="accountantLogin.php">Log out</a>
        </li>
      </ul>
    </div>
  </nav>
          ...
          <table id="t01">
            ...
            if($data){  
              ...
              <tr>
                ...
                <td><a href="updateStudent3.php?id=<?php echo $data['id']?>" data-toggle="tooltip" data-placement="bottom" title="Update"> <i class="fa fa-edit" style="font-size: 20px; color: green; align-items: center;" ></i></a></td>
              </tr>
              <?php
            }  
            else{  
